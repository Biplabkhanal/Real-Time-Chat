...
export default function FriendRequestsContent({ auth, onClose }) {
    ...
    const fetchFriendRequestsData = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const dataResponse = await fetch("/api/friend-requests");
                if (dataResponse.ok) {
    ...
    const acceptFriendRequest = async (requestId) => {
        try {
            ...
            if (response.ok) {
                toast.success(data.message);
                fetchFriendRequestsData(); // Refresh data
            } else {
    ...
    const removeFriend = async (friendId) => {
        try {
            const response = await fetch(`/friend/remove/${friendId}`, {
                method: "POST",
                headers: {
                    "X-CSRF-TOKEN": document
                        .querySelector('meta[name="csrf-token"]')
